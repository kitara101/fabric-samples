...
node query.js channel-1 org1 org1
#node query.js channel-1 org2 org1
#node query.js channel-1 org1 org2
node query.js channel-2 org2 org2
echo "Quierying from partner's peer"
#node query.js channel-1 org4 org1
#node query.js channel-2 org5 org3
echo "Inserting transaction on own peer"

node invoke.js channel-1 org1 org1
node invoke.js channel-2 org2 org2
echo "Inserting transaction on partners peer -- event hub should fail."
#node invoke.js channel-1 org1 org2
